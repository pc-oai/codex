...
impl From<CoreThreadUserState> for ThreadUserState {
    fn from(value: CoreThreadUserState) -> Self {
        match value {
            CoreThreadUserState::Active => ThreadUserState::Active,
            CoreThreadUserState::Done => ThreadUserState::Done,
            CoreThreadUserState::Parked => ThreadUserState::Parked,
        }
    }
}

impl From<ThreadUserState> for CoreThreadUserState {
    fn from(value: ThreadUserState) -> Self {
        match value {
            ThreadUserState::Active => CoreThreadUserState::Active,
            ThreadUserState::Done => CoreThreadUserState::Done,
            ThreadUserState::Parked => CoreThreadUserState::Parked,
        }
    }
}
