...
pub(super) const KEYMAP_ACTIONS: &[KeymapActionDescriptor] = &[
    ...
    action("global", "Global", "open_snippets", "Open snippets from the last agent response."),
    action("global", "Global", "open_touched_paths", "Open recently touched agent paths."),
    action("global", "Global", "open_model_picker", "Open the model picker."),
    action("global", "Global", "copy", "Copy the last agent response to the clipboard."),
    action("global", "Global", "redraw_full_scrollback", "Redraw the full retained backlog for the current native scrollback view."),
    action("global", "Global", "clear_terminal", "Clear the terminal UI."),
    action("global", "Global", "reload_current_session", "Reload the current session in a fresh process."),
    action("global", "Global", "toggle_condensed_transcript", "Toggle message-only main transcript view."),
    ...
    action("chat", "Chat", "rename_current_session", "Open the manual rename prompt for the current session."),
    action("chat", "Chat", "retitle_current_session", "Generate a fresh title suggestion for the current session."),
    action("chat", "Chat", "edit_queued_message", "Edit the most recently queued message."),
    action("chat", "Chat", "discard_queued_message", "Discard the most recently queued message."),
    action("chat", "Chat", "steer_queued_message", "Steer the most recently queued message now."),
    ...
    action("composer", "Composer", "toggle_submission_mode", "Toggle whether the next draft steers now or waits in the queue."),
...
pub(super) fn binding_slot<'a>(
    ...
    match (context, action) {
        ...
        ("global", "open_snippets") => Some(&mut keymap.global.open_snippets),
        ("global", "open_touched_paths") => Some(&mut keymap.global.open_touched_paths),
        ("global", "open_model_picker") => Some(&mut keymap.global.open_model_picker),
        ("global", "copy") => Some(&mut keymap.global.copy),
        ("global", "redraw_full_scrollback") => Some(&mut keymap.global.redraw_full_scrollback),
        ("global", "clear_terminal") => Some(&mut keymap.global.clear_terminal),
        ("global", "reload_current_session") => Some(&mut keymap.global.reload_current_session),
        ("global", "toggle_condensed_transcript") => Some(&mut keymap.global.toggle_condensed_transcript),
        ...
        ("chat", "rename_current_session") => Some(&mut keymap.chat.rename_current_session),
        ("chat", "retitle_current_session") => Some(&mut keymap.chat.retitle_current_session),
        ("chat", "edit_queued_message") => Some(&mut keymap.chat.edit_queued_message),
        ("chat", "discard_queued_message") => Some(&mut keymap.chat.discard_queued_message),
        ("chat", "steer_queued_message") => Some(&mut keymap.chat.steer_queued_message),
        ("composer", "submit") => Some(&mut keymap.composer.submit),
        ("composer", "queue") => Some(&mut keymap.composer.queue),
        ("composer", "toggle_submission_mode") => Some(&mut keymap.composer.toggle_submission_mode),
...
pub(super) fn bindings_for_action<'a>(
    ...
    match (context, action) {
        ...
        ("global", "open_snippets") => Some(runtime_keymap.app.open_snippets.as_slice()),
        ("global", "open_touched_paths") => Some(runtime_keymap.app.open_touched_paths.as_slice()),
        ("global", "open_model_picker") => Some(runtime_keymap.app.open_model_picker.as_slice()),
        ("global", "copy") => Some(runtime_keymap.app.copy.as_slice()),
        ("global", "redraw_full_scrollback") => Some(runtime_keymap.app.redraw_full_scrollback.as_slice()),
        ("global", "clear_terminal") => Some(runtime_keymap.app.clear_terminal.as_slice()),
        ("global", "reload_current_session") => Some(runtime_keymap.app.reload_current_session.as_slice()),
        ("global", "toggle_condensed_transcript") => Some(runtime_keymap.app.toggle_condensed_transcript.as_slice()),
        ...
        ("chat", "rename_current_session") => Some(runtime_keymap.chat.rename_current_session.as_slice()),
        ("chat", "retitle_current_session") => Some(runtime_keymap.chat.retitle_current_session.as_slice()),
        ("chat", "edit_queued_message") => Some(runtime_keymap.chat.edit_queued_message.as_slice()),
        ("chat", "discard_queued_message") => Some(runtime_keymap.chat.discard_queued_message.as_slice()),
        ("chat", "steer_queued_message") => Some(runtime_keymap.chat.steer_queued_message.as_slice()),
        ("composer", "submit") => Some(runtime_keymap.composer.submit.as_slice()),
        ("composer", "queue") => Some(runtime_keymap.composer.queue.as_slice()),
        ("composer", "toggle_submission_mode") => Some(runtime_keymap.composer.toggle_submission_mode.as_slice()),
